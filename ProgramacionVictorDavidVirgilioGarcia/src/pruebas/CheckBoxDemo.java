...
public class CheckBoxDemo extends JPanel {
    ...
    public CheckBoxDemo() {
        ...
        //XXX: In 1.0.2 only, must use FixedJCheckBox instead of JCheckBox
	//XXX: if you want mnemonics to work.
        ...
        picture = new JLabel(new ImageIcon("images/geek-" + choices.toString() + ".gif"));
        picture.setToolTipText(choices.toString());
    ...
    class CheckBoxListener implements ItemListener {
        public void itemStateChanged(ItemEvent e) {
            ...
            picture.setIcon(new ImageIcon("images/geek-" + choices.toString() + ".gif"));
            picture.setToolTipText(choices.toString());
        }
    }
